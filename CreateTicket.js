    ...
    return ( 
        <div className='container'>
            <div className='row p-5 mt-5 mb-5'>
                <h1 className='fs-2 pb-3'>To create a ticket, select a relevant topic</h1>
                <div className='col-4 pt-5'>
                    ...
                    <a href='' style={{textDecoration:"none",lineHeight:"0.5"}}>Company, Partnership and HUF Account <br/>opening</a><br/>
                ...
                <div className='col-4 pt-5'>
                    ...
                    <a href='' style={{textDecoration:"none",lineHeight:"0.5"}}>DP ID and bank details</a><br/>
                ...
                <div className='col-4 pt-5'>
                    <h5><i class="fa fa-bar-chart" aria-hidden="true"></i>&nbsp;Your Zerodha Account</h5>
                    ...
                    <a href='' style={{textDecoration:"none",lineHeight:"0.5"}}>Trading FAQs</a><br/>
                ...
                <div className='col-4 pt-5'>
                    <h5><i class="fa fa-bar-chart" aria-hidden="true"></i>&nbsp;Funds</h5>
                ...
                <div className='col-4 pt-5'>
                    ...
                    <a href='' style={{textDecoration:"none",lineHeight:"0.5"}}>Buying and Selling through Coin</a><br/>
